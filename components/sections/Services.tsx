  ...
  return (
    <AnimatedSection id="services" className="bg-black py-28" variants={container}>
      <section>
        ...
        <div className="mx-auto w-full lg:w-[1200px] lg:h-[160px] rounded-none flex justify-between items-start lg:items-center rotate-0 opacity-100 mb-12">
          ...
          <div className="w-1/2 flex items-start justify-end">
            <p className="text-zinc-400 w-full text-base leading-relaxed text-left lg:text-right mt-0">
        ...
        <motion.div variants={container} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 lg:col-span-9 lg:col-start-4">
          {SERVICES.map((s, i) => (
